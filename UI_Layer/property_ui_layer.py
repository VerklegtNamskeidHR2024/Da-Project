...
class property_UI_menu:
    ...
    def set_name_for_property(self, new_property: object) -> str:
        ...
        while (property_name := input("Enter the property name: ")) not in [
            "q",
            "b",
            "Q",
            "B",
    ...
    def set_location_name_for_properties(self, new_property: object) -> str:
        ...
        if self.rank == "Admin":
            while (new_location := input("Enter the property location: ")) not in [
                "q",
                "b",
                "Q",
                "B",
    ...
    def set_condition_for_property(self, new_property: object) -> str:
        ...
        while (new_condition := input("Enter the property condition: ")) not in [
            "q",
            "b",
            "Q",
            "B",
    ...
    def set_property_price(self, new_property: object) -> str:
        while (new_price := input("Enter the property price: ")) not in [
            "q",
            "b",
            "Q",
            "B",
    ...
    def property_creation_confirmation(self, new_property: object) -> str:
        ...
        print("-" * 70)
        print()
        self.logic_wrapper.add_new_property_to_storage(
            self.rank, self.location, new_property
        )
    ...
    def display_add_amenity(self):
        ...
        new_property = House(
            "", new_name, new_location, new_condition, new_price_to_fix, new_price
        )
        self.logic_wrapper.add_new_property_to_storage(
            self.rank, self.location, new_property
        )
