...
property1 = House('H1', 'suite', 'Reykjavik', 'excellent', 1500.0, 30230)
property2 = House('H2', 'suite', 'Reykjavik', 'fair', 1200.0, 300)
property3 = House('H3', 'suite', 'Reykjavik', 'excellent', 1500.0, 30)
property4 = House('H4', 'suite', 'Reykjavik', 'fair', 1200.0, 30)
property5 = House('H5', 'suite', 'Reykjavik', 'excellent', 1500.0, 30)
property6 = House('H6', 'suite', 'Nuuk', 'fair', 1200.0, 300)
property7 = House('H7', 'suite', 'Nuuk', 'excellent', 1500.0, 300)
property8 = House('H8', 'suite', 'Nuuk', 'fair', 1200.0, 30)
property9 = House('H9', 'suite', 'Nuuk', 'excellent', 1500.0, 300000000)
property10 = House('H10', 'suite', 'Nuuk', 'fair', 1200.0, 30000000000)
property11 = House('H11', 'suite', 'Kulusuk', 'excellent', 1500.0, 30000000)
property12 = House('H12', 'suite', 'Kulusuk', 'excellent', 1500.0, 300000000)
property13 = House('H13', 'suite', 'Kulusuk', 'excellent', 1500.0, 3000000)
property14 = House('H14', 'suite', 'Kulusuk', 'excellent', 1500.0, 30000000000)
property15 = House('H15', 'suite', 'Kulusuk', 'excellent', 1500.0, 30000000000)
property16 = House('H16', 'suite', 'Thorshofn', 'excellent', 1500.0, 30000000)
property17 = House('H17', 'suite', 'Thorshofn', 'fair', 1200.0, 300000000)
property18 = House('H18', 'suite', 'Thorshofn', 'excellent', 1500.0, 30000000000)
property19 = House('H19', 'suite', 'Thorshofn', 'excellent', 1500.0, 30000000)
property20 = House('H20', 'suite', 'Thorshofn', 'excellent', 1500.0, 300000000)
property21 = House('H21', 'suite', 'Thorshofn', 'fair', 1200.0, 300000000)
property22 = House('H22', 'suite', 'Tingwall', 'excellent', 1500.0, 300000000)
property23 = House('H23', 'suite', 'Tingwall', 'excellent', 1500.0, 300000000)
property24 = House('H24', 'suite', 'Tingwall', 'excellent', 1500.0, 3000000)
property25 = House('H25', 'suite', 'Tingwall', 'excellent', 1500.0, 30000000)
property26 = House('H26', 'suite', 'Tingwall', 'fair', 1200.0, 30000000000)
property27 = House('H27', 'suite', 'Longyearbyen', 'excellent', 1500.0, 300000000)
property28 = House('H28', 'suite', 'Longyearbyen', 'excellent', 1500.0, 30000000)
property29 = House('H29', 'suite', 'Longyearbyen', 'excellent', 1500.0, 30000000)
property30 = House('H30', 'suite', 'Longyearbyen', 'fair', 1200.0, 30000000)
...
work_request1 = WorkRequest('WR1', 'Fix HotTub', 'Hot tub was leaking ketchup for some odd reason?', 'MR002', 'E1234', 'Reykjavik', 'H0001','01-01-24','',False,0,'High','MR0002','Pending',False,'',False)
work_request2 = WorkRequest('WR1', 'Fix roof', 'roof had giant hole in it', 'MR001', 'E1234', 'Reykjavik', 'H001','01-01-24','',False,0,'High','MR0002','Pending',False,'',False)

maintenance_report1 = MaintenanceReport('MR1', 'Fix the roof', 'Reykjavik', 'H0004', 'E5678', False, 'roof is leaking', 'Pending', '1234', True, 'C0001', 'WR0003')
