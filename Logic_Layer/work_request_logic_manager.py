class work_request_logic_manager:
    ...
    def sanity_check_work_request_id(self, work_request_id: str) -> bool:
        ...
        if (len(work_request_id_list) == 3 and work_request_id_list[0] == "W" and work_request_id_list[1] == "R") == True:
            return True
        else:
            return False  
    ...
    def sanity_check_new_work_request_property_id(self, property_id: str) -> bool:
        ...
        if (len(property_id_listed) == 2 and property_id_listed[0] == "P") == True:
            return True
        else:
            return False 
