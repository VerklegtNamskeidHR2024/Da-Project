...
class Employee(Human):
    def __init__(self, name:str="", social_security_number:str='', phone_number:str='', location:str="", system_permissions:str="Employee",
    ...
    def to_dict(self):
        ...
        # This is done to convert the Employee object to a dictionary so that it can be written to a json file more easily
        return {
            'name': self.name,
